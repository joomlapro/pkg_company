...
/**
 * HTML Employee View class for the Company component.
 *
 * @package     Company
 * @subpackage  com_company
 * @since       3.0
 */
class CompanyViewForm extends JViewLegacy
{
	protected $form;
	...
	public function display($tpl = null)
	{
		...
		if (empty($item->id))
		{
			$authorised = $user->authorise('core.create', 'com_company') || (count($user->getAuthorisedCategories('com_company', 'core.create')));
		}
		else
		{
	...
	protected function _prepareDocument()
	{
		...
		{
			$head = JText::_('COM_COMPANY_FORM_SUBMIT_EMPLOYEE');
		}
		else
		{
			$head = JText::_('COM_COMPANY_FORM_EDIT_EMPLOYEE');
		}
